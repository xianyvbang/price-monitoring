...
export const api = {
  ...
  excludePlatformDispatchGroupAccount: (groupId, accountId) => request(`/api/platform-dispatch/groups/${groupId}/accounts/${accountId}/exclude`, { method: "POST" }),
  restorePlatformDispatchGroupAccount: (groupId, accountId) => request(`/api/platform-dispatch/groups/${groupId}/accounts/${accountId}/exclude`, { method: "DELETE" }),
  ...
  adjustUsedBalance: (id, payload) => request(`/api/accounts/${id}/used-balance-adjustment`, { method: "POST", body: JSON.stringify(payload) }),
  accountAccountingHistory: (id, type = "used_balance") => request(`/api/accounts/${id}/accounting-history?type=${encodeURIComponent(type)}`),
  deleteAccountAccountingHistory: (id, recordId) => request(`/api/accounts/${id}/accounting-history/${recordId}`, { method: "DELETE" }),
  ...
  adjustTodayConsumption: (payload) => request("/api/dashboard/today-consumption-adjustment", { method: "POST", body: JSON.stringify(payload) }),
  dashboardAccountingHistory: (type = "today_consumption") => request(`/api/dashboard/accounting-history?type=${encodeURIComponent(type)}`),
  deleteDashboardAccountingHistory: (recordId) => request(`/api/dashboard/accounting-history/${recordId}`, { method: "DELETE" }),
